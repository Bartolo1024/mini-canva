...
Read `task.pdf`, `AGENTS.md`, and `docs/PROJECT_PLAN.md`. During preparation review proposed behavior without implementing tests or fixes.
...
Report observed bugs with reproductions separately from untested risks. Check the eventual demo, 1–2 page WRITEUP, and scaling discussion against the PDF. Do not demand training infrastructure or optional UI work as core requirements.
